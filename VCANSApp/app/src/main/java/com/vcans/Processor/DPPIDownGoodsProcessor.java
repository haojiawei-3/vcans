...
public class DPPIDownGoodsProcessor extends DownloadProcessor {
...
//		SimpleAdapter adpter=new SimpleAdapter(mActParent,dataList,R.layout.dp_pigoods_item,szField,szRId);
...
//		tvPage.setText("(0/"+listView.getCount()+")");
	...
	public MyProtocol GetProtocol() {
		...
		//==跟单==成品进仓-物料信息下载
		p.sendCmd1= DPProtocol.m_vfxVAG4BDePei_ShengChanHuiBaoChanChu_GongXuXuanZe1;
		p.receCmd0=DPProtocol.m_vfxVAG4BDePei_ShengChanHuiBaoChanChu_GongXuXuanZeRe0;
		p.receCmd1=DPProtocol.m_vfxVAG4BDePei_ShengChanHuiBaoChanChu_GongXuXuanZeRe1;
