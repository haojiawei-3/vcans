...
import com.vcans.dao.RZTaskDao2;
import com.vcans.model.BandleParam;
import com.vcans.model.MyProtocol;
import com.vcans.model.ToupeiInfo;
import com.vcans.tool.ActivityHelper;

public class DPRZTaskUploadProcessor2 extends UploadProcessor {

	public RZTaskDao2 mSCToupeiDao=null;
	...
	public DPRZTaskUploadProcessor2()
	{
		mSCToupeiDao=new RZTaskDao2();
	...
	public Vector<Vector<String>> GetSendData(String[] extrData) {
		...
		for(HashMap<String,Object> mapToupei:mTouPeiList)
		{
			...
			//上传记录格式[染整计划号,染整厂编码,工序编码,工序名称,工艺编码,工艺名称,日期时间,匹数,数量,备注]
	...
	public MyProtocol GetProtocol() {
		...
		p.sendCmd0=DPProtocol.m_vfxVAG4BDePei_RanZhengRenWuJianBaoerBiao0;
		p.sendCmd1= DPProtocol.m_vfxVAG4BDePei_RanZhengRenWuJianBaoerBiao1;
		p.sendCmd2=DPProtocol.m_vfxVAG4BDePei_RanZhengRenWuJianBaoerBiao2;
		p.receCmd0=DPProtocol.m_vfxVAG4BDePei_RanZhengRenWuJianBaoerBiaoRe0;
		p.receCmd1=DPProtocol.m_vfxVAG4BDePei_RanZhengRenWuJianBaoerBiaoRe1;
		p.receCmd3=DPProtocol.m_vfxVAG4BDePei_RanZhengRenWuJianBaoerBiaoRe3;
		p.receCmd5=DPProtocol.m_vfxVAG4BDePei_RanZhengRenWuJianBaoerBiaoRe5;
