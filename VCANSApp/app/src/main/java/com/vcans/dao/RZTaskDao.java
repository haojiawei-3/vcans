...
public class RZTaskDao {

	String mDbPath;
	SQLiteDatabase mDatabase=null;
	String mWhereSQL=null;
	private final String tableName ="RZTask";
	public RZTaskDao()
	{
	...
	public int DeleteAll(String strIds)
	{
		...
		String strSQL="DELETE FROM RZTask ";
	...
	public int DeleteById(String strIds)
	{
		...
		String strSQL="DELETE FROM RZTask WHERE TPId="+Integer.valueOf(strIds);
	...
	public int AddToupei(ToupeiInfo toupei)
	{
		...
		try
		{
			...
			rst=(int) mDatabase.insert("RZTask", null, contentValues);
		}
		catch(Exception e)
		{
