...
public class MipcaActivityCapture extends Activity implements Callback , View.OnClickListener{
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(resultCode == RESULT_OK){//�ɹ�
			...
			case REQUEST_CODE:
				...
				mProgress.setMessage(getString(R.string.executing));
	...
	public Result scanningImage(String path) {
		...
		if(fileSizkKb>=(1024*2))
		{
			options.inSampleSize = 1/4;
		}
		else if(fileSizkKb>=(1024))
		{
	...
	private void onResultHandler(String resultString, Bitmap bitmap){
		if(TextUtils.isEmpty(resultString)){
			Toast.makeText(MipcaActivityCapture.this, "vcans  you  can!", Toast.LENGTH_SHORT).show();
			return;
		}
