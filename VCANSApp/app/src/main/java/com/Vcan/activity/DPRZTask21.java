...
import com.vcans.Processor.DPRZTaskUploadProcessor2;
 ...
 *
 */
public class DPRZTask21 extends BaseActivity {
	// public static DPRZTask1 dprzTask1 = null;
	private DPRZTaskUploadProcessor2 mUploadTouPei=null;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		mUploadTouPei=new DPRZTaskUploadProcessor2();
			...
			if (event.getAction() == MotionEvent.ACTION_DOWN) {
				...
				new Handler().post(new Runnable(){
					...
					public void run() {
						...
						AlertDialog.Builder builder = new AlertDialog.Builder(DPRZTask21.this);
						View view = View.inflate(DPRZTask21.this, R.layout.datetime_dialog, null);
