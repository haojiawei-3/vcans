...
import com.vcans.Processor.DPRZTaskDownFactoryProcessor2;
import com.vcans.Processor.DPRZTaskDownWorkProcessor;
import com.vcans.Processor.DPRZTaskDownWorkProcessor2;
...
/**
 * 任务简报二   有2个界面类 分别  DPRZTask2  DPRZTask21
 * @author vcans
 *
 */
public class DPRZTask2 extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		sendParam.processor = new DPRZTaskDownWorkProcessor2();
	...
	public  Handler mDpHandler=new Handler()
	{
		...
		public void handleMessage(Message msg)
		{
			...
			{
				ActivityHelper.hidesofeKeyboard(DPRZTask2.this);
			}
		}
	};
	...
	public void onLoadFactoryName()
	{
		...
		SendParam sendParam = new SendParam();
		sendParam.parent = this;
		sendParam.processor = new DPRZTaskDownFactoryProcessor2();
	...
	public void onNext()
	{
		...
		Intent intent=new Intent(this,DPRZTask21.class);
