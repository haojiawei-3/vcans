    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        ...
        if (aMapLocation != null) {
            if (aMapLocation.getErrorCode() == 0) {
                ...
                SplashActivity.setProvince(aMapLocation.getProvince());
                //aMapLocation.getProvince(); // 省信息
                SplashActivity.setCity(aMapLocation.getCity());
               // aMapLocation.getCity(); // 城市信息
                SplashActivity.setDistrict(aMapLocation.getDistrict());
                //aMapLocation.getDistrict(); // 城区信息
                SplashActivity.setStreet(aMapLocation.getStreet()+ aMapLocation.getStreetNum());
